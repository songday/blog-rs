...
use blog_common::dto::post::{PostDetail, PostData};
...
impl Component for PostCompose {
  ...
  fn update(&mut self, ctx: &Context<Self>, msg: Self::Message) -> bool {
      match msg {
        Msg::UpdatePostData(post_detail) => {}
        ...
        Msg::Files(post_id, files) => {
            ...
            let js_callback = Closure::once_into_js(move |payload: String| {
