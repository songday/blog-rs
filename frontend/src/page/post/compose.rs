      ...
      html! {
              ...
              <div class="file is-normal">
                <label class="file-label">
                  ...
                  <span class="file-cta">
                    ...
                    <span class="file-label">{"上传图片/UploadImage"}</span>
                  </span>
                </label>
              </div>
            </p>
        ...
        <div class="container">
          ...
          <div class="field is-grouped">
            <div class="control">
              <button class="button is-link" onclick={ctx.link().callback(|_| Msg::PostRequest)}>{ "更新/Update" }</button>
            </div>
            <div class="control">
